        ...
        return [
          ...
          ElevatedButton.icon(
            ...
            onPressed: () async {
              ...
              // Usar el servicio DriverOrderService para marcar como entregado
              try {
                await DriverOrderService.markDelivered(orderId);
                await controller.loadActiveOrders(); // Recargar los pedidos
                ...
                debugPrint('Error al marcar pedido como entregado: $e');
                // Cerrar indicador de carga
                //ignore: use_build_context_synchronously
                Navigator.of(context).pop();
